...
void loop() {  
  ...
  if (Serial.available()) {  // check for incoming serial data
      ...
      } else if (command == "red") {  // turn off LED
         colorWipe(strip.Color(255, 0, 0), 50); // Red
         delay(5000);
         colorWipe(strip.Color(0, 0, 255), 50); // Blue  
         
      }else if (command == "blue") {  // turn off LED
         colorWipe(strip.Color(0, 0, 255), 50); // Blue         
      }else if (command == "find") {  // turn off LED         
         sing(2);
      } else if (command == "pink") {  // turn off LED         
         sing(3);
      }
   }
}
...
void sing(int s) {
  ...
  if (song == 2) {
    ...
    for (int thisNote = 0; thisNote < size; thisNote++) {
      ...
      tone(melodyPin, melody1[thisNote], noteDuration * 0.9);
